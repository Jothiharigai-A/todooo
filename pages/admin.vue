<template>
  <div class="mt-10 mx-20">
    <table class="border-collapse table-auto w-full bg-gradient-to-r from-blue-600 to-purple-400 text-sm px-4 border-l-4 border-r-4">
      <thead>
        <tr>
          <th
      ...
      <tbody class="bg-white dark:bg-slate-800">
        <tr v-for="instagramapp of instas" :key="instagramapp.id">
          ...
          >
            <button class=" text-white font-semibold hover:scale-x-125  rounded-2xl p-2 bg-gradient-to-r from-blue-600 to-purple-400" @click="editPost(instagramapp)">Edit</button>
            <button class=" text-white font-semibold hover:scale-x-125 rounded-2xl p-2 bg-gradient-to-r from-blue-600 to-purple-400" @click="deletePost(instagramapp)">Delete</button>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <button class="absolute w-6 h-6 bg-red-400 text-white border rounded-full shadow-2xl -top-5 -right-2" @click="showModal = false">X</button>
    </div>
  </div>
</template>
